...
ref autoptr TStringArray itemList_08 	= {"0.7","Random","Ammo_22","Megaphone","Handcuffs","HandcuffKeys","Handcuffs","HandcuffKeys","Ammo_45ACP","Ammo_380","MP5_Compensator","PistolOptic","PistolSuppressor",};
ref autoptr TStringArray vestList_08 	= {"0.0","Random","",};
...
ref autoptr TStringArray itemList_09 	= {"0.5","Pristine","Ammo_9x19","Ammo_9x39","AK_Suppressor","PistolSuppressor",};
ref autoptr TStringArray vestList_09 	= {"0.1","Random","BaseRadio",};
...
ref autoptr TStringArray itemList_10 	= {"1.0","BadlyDamaged","FNX45","PistolSuppressor",};
...
ref autoptr TStringArray itemList_15	= {"0.5","Pristine","Ammo_9x19","Ammo_9x39","AK_Suppressor","PistolSuppressor",};
ref autoptr TStringArray vestList_15 	= {"0.0","Random","",};
